...
//                     setGlobalCurrency(fetchedItems[0].currency)
//                 }
//
//             } catch (err: any) {
//                 const errorMsg = err?.response?.data?.detail || "Failed to load menu items";
...
// }, [globalCurrency]);
//
//     const isCurrencyLocked = items.length > 0;
//
//     return (
//         <div className={styles.itemsWrapper}>
//              <div className={styles.wrapperTitle}>
...
//                         All items in this venue must use the same currency.
//                         This setting will apply to all services within the venue.
//                     </p>
//                 ) : (
